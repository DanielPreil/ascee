import { asceeCreateCanvas, asceeCreateModel, asceeCreateLight } from "./node_modules/ascee/index.js"

window.addEventListener("DOMContentLoaded", () => {
  
  // Grab The Model, Canvas
  ...
  // create the model of yours and display it on the scene
  asceeCreateModel(modelElement, asceeRenderer, asceeScene, asceeCamera)
